...
<div class="navbar-brand m-0 p-0 d-inline-flex gap-5 position-absolute top-50 start-50 translate-middle">
    ...
    <a class="m-0 p-0 text-decoration-none {{ Request::is('comissao/docentes*') ? 'fw-bold' : '' }}" style="color: black; font-family: 'Inter', sans-serif;" href="{{ route("gestorDocentes") }}">Gestor de Docentes</a>
