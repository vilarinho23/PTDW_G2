    ...
    <div class="p-5  " style="min-height: 80vh;">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active text-black" id="uc0-tab" data-bs-toggle="tab" data-bs-target="#uc0"
                    type="button" role="tab" aria-controls="uc0" aria-selected="true">Nome UC 1</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link text-black" id="uc1-tab" data-bs-toggle="tab" data-bs-target="#uc1"
                    type="button" role="tab" aria-controls="uc1" aria-selected="false">Nome UC 2</button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fadey p-5 show active tabela shadow-lg p-3 mb-5 bg-white rounded" id="uc0"
                role="tabpanel" aria-labelledby="uc0-tab">
                <div class="d-flex ">
                ...
                <div>
                    ...
                    <div class="p-1">
                        ...
                        <div class="d-flex gap-3 ">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle" type="button"
                                    id="dropdownLaboratorio0Uc0" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    Dropdown button
                                </button>
                            ...
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle" type="button"
                                    id="dropdownLaboratorio1Uc0" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    Dropdown button
                                </button>
                            ...
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle" type="button"
                                    id="dropdownLaboratorio2Uc0" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    Dropdown button
                                </button>
                            ...
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle" type="button"
                                    id="dropdownLaboratorio3Uc0" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    Dropdown button
                                </button>
                        ...
                        <div class="d-flex gap-5">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle" type="button"
                                    id="dropdownAvaliacaoUc0" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    Dropdown button
                                </button>
            ...
            <div class="tab-pane fade tabela shadow-lg p-3 mb-5 bg-white rounded" id="impedimentos" role="tabpanel"
                ...
                <div class="d-flex justify-content-end mt-5">
                    <button type="button" class="button-style" id="botao-preencher" data-bs-toggle="modal"
                        data-bs-target="#submeterModal">Submeter</button>
                </div>
                <div class="modal" id="submeterModal" tabindex="-1" aria-labelledby="submeterModalLabel"
                    aria-hidden="true">
