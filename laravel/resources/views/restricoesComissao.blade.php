    ...
    <div class="p-5 pt-0" style="min-height: 80vh;">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link text-black active" id="impedimentos-tab" data-bs-toggle="tab"
            ...
            @foreach ($ucs as $uc)
                ...
                @if ($isResponsavel)
                    <li class="nav-item" role="presentation">
                        <button class="nav-link text-black" data-bs-toggle="tab" data-bs-target="{{$dataBsTarget}}" id="{{$id}}"
        ...
        <div class="tab-content" id="myTabContent">
            {{-- Tab para impedimentos --}}
            <div class="tab-pane fade tabela shadow-lg p-3 mb-5 bg-white rounded position-relative active show" id="impedimentos" role="tabpanel"
            ...
            @foreach ($ucs as $uc)
                ...
                @endphp
                @if ($isResponsavel)
                    <div class="tab-pane fade tabela shadow-lg p-5 mb-5 bg-white position-relative rounded" id="{{$id}}"
