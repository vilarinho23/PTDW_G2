...
<body>
    ...
    <div class="container p-0 d-flex flex-column align-items-center mx-auto" style="width: fit-content; margin-top: 200px;">
        ...
        <div class="mt-4">
            <button class="button-style me-4" style="width: 150px; height: 40px; font-size: 20px">Docente</button>
            <button class="button-style" style="width: 150px; height: 40px; font-size: 20px">Comissão</button>
        </div>
    </div>
</body>
</html>
